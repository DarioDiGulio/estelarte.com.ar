...
function loadPictures() {
  dataCuadros.forEach((picture) => {
    const pictures = document.getElementById(`${picture.category}-pictures`);
    pictures.innerHTML += `
        <li>
